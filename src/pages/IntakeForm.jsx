...
const HOUSE_RULES = `CLEARPATH RECOVERY HOUSING — RESIDENT AGREEMENT & HOUSE RULES

1. SOBRIETY: Residents must maintain complete abstinence from all non-prescribed mood-altering substances. Any use constitutes grounds for immediate discharge.

2. DRUG TESTING: Residents consent to random drug and alcohol testing at any time, without prior notice.

3. CURFEW: All residents must comply with house curfew as posted. Any exception requires advance approval from the house manager.

4. MEETINGS: Residents are required to attend a minimum of three (3) recovery support meetings per week and provide documentation.

5. CHORES: Each resident is assigned weekly household responsibilities. Completion is mandatory.

6. GUESTS: Guests are permitted only in common areas and only during approved visiting hours. No overnight guests.

7. RENT: Resident agrees to pay program fees on or before the due date each month. Non-payment may result in discharge.

8. CONDUCT: Residents will treat all community members, staff, and neighbors with respect. Violence, threats, harassment, or intimidation will result in immediate discharge.

9. MEDICATIONS: All prescription medications must be disclosed to staff and stored per house protocol. MAT medications require documentation.

10. CONFIDENTIALITY: Residents will respect the privacy of fellow residents. What is shared in the house stays in the house.

11. PROPERTY: Residents are responsible for their personal belongings. ClearPath is not liable for lost or stolen items.

12. COMPLIANCE: Residents must comply with all local, state, and federal laws. Any arrest must be reported to staff immediately.

By signing below, I acknowledge that I have read, understand, and agree to abide by all of the above house rules and policies. I understand that violation of these rules may result in discharge from the program.`;
