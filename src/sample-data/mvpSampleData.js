  ...
  const tables = {
    ...
    audit_logs: [
      sampleMeta({
        ...
        performed_by_name: 'Sample Admin',
        resident_id: ids.residentJordan,
        action: 'viewed_record',
        resource_type: 'resident',
        resource_id: ids.residentJordan,
        description: 'SAMPLE: Audit trail entry for resident profile view.',
        ip_address: '127.0.0.1',
        access_reason: 'SAMPLE UI testing',
      }),
    ],
    inventory_items: [
      sampleMeta({
